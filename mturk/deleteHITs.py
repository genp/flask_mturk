...
def get_all_hits(hfile):
    ...
    baseurl = "https://mechanicalturk.amazonaws.com/?Service=%s&AWSAccessKeyId=%s&Operation=%s&Signature=%s&Timestamp=%s&SortProperty=Title&PageSize=100&PageNumber=" % (service, config.mturk_access_key, method, signature, timestamp)
    pageind = 0
